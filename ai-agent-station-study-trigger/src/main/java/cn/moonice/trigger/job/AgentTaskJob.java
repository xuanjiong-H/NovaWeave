package cn.moonice.trigger.job;

import cn.moonice.domain.agent.model.entity.ExecuteCommandEntity;
import cn.moonice.domain.agent.model.valobj.AiAgentTaskScheduleVO;
import cn.moonice.domain.agent.service.IAgentDispatchService;
import cn.moonice.domain.agent.service.ITaskService;
import cn.moonice.types.job.model.TaskScheduleVO;
import cn.moonice.types.job.provider.ITaskDataProvider;
