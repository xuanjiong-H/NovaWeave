package cn.moonice.types.job.config;

import cn.moonice.types.job.TaskJob;
import cn.moonice.types.job.provider.ITaskDataProvider;
import cn.moonice.types.job.service.ITaskJobService;
import cn.moonice.types.job.service.TaskJobService;
