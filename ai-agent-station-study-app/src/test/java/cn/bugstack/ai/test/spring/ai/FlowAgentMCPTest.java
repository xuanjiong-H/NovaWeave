...
public class FlowAgentMCPTest {
    ...
    public void test() {
        ...
        ChatResponse call = chatModel.call(Prompt.builder()
                .messages(new SystemMessage("""
                                ...
                                """),
                        new UserMessage("我需要做一个外卖项目，请帮我规划执行步骤，之后我会调用配置 ai 的mcp 执行。"))
                .build());

        // 检索小傅哥的项目，并提供学习路线
        log.info("测试结果:{}", call.getResult().toString());
    }
    ...
    public McpSyncClient stdioMcpClientElasticsearch() {
        ...
        env.put("ES_HOST", System.getenv("ES_URL"));
        env.put("ES_API_KEY", System.getenv("ES_API_KEY"));
    ...
    public McpSyncClient stdioMcpClient_Grafana() {
        Map<String, String> env = new HashMap<>();
        env.put("GRAFANA_URL", System.getenv("GRAFANA_URL"));
        env.put("GRAFANA_API_KEY", System.getenv("GRAFANA_API_KEY"));
    ...
    public McpSyncClient sseMcpClient_BaiduSearch() {
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder(System.getenv("BAIDU_BASE_URL"))
    ...
    public McpSyncClient sseMcpClient_csdn() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder(System.getenv("CSDN_MCP_URL")).build();
    ...
    public McpSyncClient sseMcpClient02_weixin() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder(System.getenv("WEIXIN_MCP_URL")).build();
